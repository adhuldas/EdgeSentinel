...
edgesentinel runs one process per device, so a single :mod:`sqlite3` connection
...
class Database:
    ...
    async def migrate(self) -> None:
        """Apply any migrations from :data:`edgesentinel.persistence.migrations.MIGRATIONS`
