"""Filesystem usage primitives used by :class:`~edgesentinel.storage.monitor.StorageMonitor`.

Kept separate from the monitor itself for the same reason as
:mod:`edgesentinel.network.checks`: the monitor should have no opinion about
