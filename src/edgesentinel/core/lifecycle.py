...
This is deliberately separate from :mod:`edgesentinel.core.runtime` so the
...
``EdgeSentinel`` instance and its subsystems.
"""
...
from edgesentinel.core.events import Event, EventBus, Severity, StateChangeEvent
from edgesentinel.core.state import RuntimeState, StateMachine

logger = logging.getLogger("edgesentinel.lifecycle")
...
class LifecycleManager:
    ...
    async def set_state(self, target: RuntimeState, *, component: str = "runtime") -> None:
        ...
        :class:`~edgesentinel.core.exceptions.InvalidStateTransitionError`
