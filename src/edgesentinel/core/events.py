...
edgesentinel emits a structured :class:`Event` for every occurrence worth
...
logger = logging.getLogger("edgesentinel.events")
...
class Event:
    """A single point-in-time occurrence recorded by edgesentinel.
