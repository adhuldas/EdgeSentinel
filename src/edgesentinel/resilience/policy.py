...
``EdgeSentinel.reliable()`` is the primary developer-facing API for making an
...
from edgesentinel.resilience.timeout import with_timeout

logger = logging.getLogger("edgesentinel.resilience")
...
def build_reliable_decorator(
    *,
    ...
    """Build the decorator returned by ``EdgeSentinel.reliable(...)``.

    See :meth:`edgesentinel.core.runtime.EdgeSentinel.reliable` for the parameter
