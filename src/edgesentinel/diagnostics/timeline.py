...
Every :class:`~edgesentinel.core.events.Event` published on the runtime's
:class:`~edgesentinel.core.events.EventBus` is transient -- it's delivered to
...
class TimelineStore(Protocol):
    ...
    Satisfied structurally by :class:`edgesentinel.persistence.database.Database`
...
class EventLog:
    ...
    Args:
        store: Persistence backend, structurally typed as
            :class:`TimelineStore` (a :class:`~edgesentinel.persistence.database.Database`
            in practice).
    """
