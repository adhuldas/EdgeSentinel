...
:mod:`edgesentinel.storage.checks`: the monitor should have no opinion about
...
``psutil``, no external dependency -- consistent with edgesentinel shipping
...
def cpu_load_ratio() -> float:
    ...
    # edgesentinel.integrations.mqtt.
