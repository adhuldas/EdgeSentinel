"""Lifecycle state machine for the EdgeGuard runtime.
...
:class:`~edgeguard.core.exceptions.InvalidStateTransitionError`. Making
...
class RuntimeState(enum.Enum):
    """Lifecycle states of an :class:`~edgeguard.core.runtime.EdgeGuard` instance."""
