...
Kept separate from the domain objects (:mod:`edgeguard.diagnostics.timeline`,
:mod:`edgeguard.diagnostics.incidents`) so the CLI and any future dashboard
...
from edgeguard.core.events import Event
